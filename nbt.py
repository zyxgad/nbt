...
TAG_LIST = 9
TAG_COMPOUND = 10   #0xa
TAG_INT_ARRAY = 11  #0xb
TAG_LONG_ARRAY = 12 #0xc
...
class _TAG_End(TAG):
    ...
    def copy(self):
        return _TAG_End() if self.__class__.INSTANCE is None else self.__class__.INSTANCE
